import{_ as s,c as n,o as a,N as l}from"./chunks/framework.0799945b.js";const D=JSON.parse('{"title":"promise.all方法","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/js&css/promise.all.md"}'),e={name:"FrontEnd/js&css/promise.all.md"},p=l(`<h1 id="promise-all方法" tabindex="-1">promise.all方法 <a class="header-anchor" href="#promise-all方法" aria-label="Permalink to &quot;promise.all方法&quot;">​</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 手写实现promise.all方法</span></span>
