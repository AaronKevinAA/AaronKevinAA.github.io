import{_ as s,c as n,o as a,N as l}from"./chunks/framework.0799945b.js";const _=JSON.parse('{"title":"下划线转驼峰","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/js&css/underline-camelcase.md"}'),e={name:"FrontEnd/js&css/underline-camelcase.md"},p=l(`<h1 id="下划线转驼峰" tabindex="-1">下划线转驼峰 <a class="header-anchor" href="#下划线转驼峰" aria-label="Permalink to &quot;下划线转驼峰&quot;">​</a></h1><p>腾讯云智笔试</p><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 实现一个函数： underlineToCamelCase</span></span>
