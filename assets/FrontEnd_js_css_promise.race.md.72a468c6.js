import{_ as s,c as n,o as a,N as e}from"./chunks/framework.0799945b.js";const D=JSON.parse('{"title":"promise.race实现","description":"","frontmatter":{},"headers":[],"relativePath":"FrontEnd/js&css/promise.race.md"}'),p={name:"FrontEnd/js&css/promise.race.md"},l=e(`<h1 id="promise-race实现" tabindex="-1">promise.race实现 <a class="header-anchor" href="#promise-race实现" aria-label="Permalink to &quot;promise.race实现&quot;">​</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">// 手写实现promise.race方法</span></span>
...
<span class="line"><span style="color:#A6ACCD;">})</span></span>
<span class="line"><span style="color:#A6ACCD;"></span></span></code></pre></div>`,2),o=[l];function r(c,t,i,C,A,m){return a(),n("div",null,o)}const _=s(p,[["render",r]]);export{D as __pageData,_ as default};
